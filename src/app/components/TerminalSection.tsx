...
const COMMANDS: Record<string, () => string[]> = {
  ...
  cert: () => [
    ...
    '2. Google Cybersecurity Professional Certificate -- Google',
    '3. SAP Deployment on Google Cloud -- Google Cloud',
    '4. AWS Training Certificate -- IPSR Solutions Ltd.',
    '5. Cloud Infrastructure Foundations -- Oracle',
    '6. Python for Data Science -- NPTEL',
  ],
  linkedin: () => [
